...
plasmaApp = Plasma.App {
   ...
   tEnd = 20*L_n/vti, -- end time
   nFrame = 1, -- number of output frames
   lower = {r0 - .001*dr/2, -dr/2, -L_parallel/2}, -- configuration space lower left
   upper = {r0 + .001*dr/2,  dr/2, L_parallel/2}, -- configuration space upper right
