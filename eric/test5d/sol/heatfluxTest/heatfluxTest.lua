-- Initialize with a maxwellian, calculate heat flux out of box 
-- mpiexec -n 1 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i heatfluxTest.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "heatfluxTest"
