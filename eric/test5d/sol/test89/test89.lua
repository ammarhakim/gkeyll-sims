...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test89.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "test89"
...
function rk1(tCurr, myDt)
  ...
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {f1Elc, hamilKeElc, bField3d}, {kineticEnergyElc})
...
function writeFields(frameNum, tCurr)
  ...
  beforePosEnergyVec:write( string.format("beforePosEnergyVec_%d.h5", frameNum), tCurr)
  afterPosEnergyVec:write( string.format("afterPosEnergyVec_%d.h5", frameNum), tCurr)
  ...
  if Lucee.getRank() == 0 then
    ...
    os.execute("mv ".. filename .. "_" .. string.format("beforePosEnergyVec_%d.h5", frameNum) .. " dynvector")
    os.execute("mv ".. filename .. "_" .. string.format("afterPosEnergyVec_%d.h5", frameNum) .. " dynvector")
  end
end
