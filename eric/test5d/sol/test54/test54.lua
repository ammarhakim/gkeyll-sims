...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test54.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function calcLenardBernsteinElc(tCurr, myDt, fInitial, fFinal)
  ...
  runUpdater(mom2VParaElcCalc, tCurr, myDt, {fInitial, bField3d}, {mom2dir3Elc})
  mom2dir3Elc:scale(2*math.pi/elcMass)
  
  runUpdater(mom1MuElcCalc, tCurr, myDt, {fInitial, bField3d}, {mom1dir4Elc})
  mom1dir4Elc:scale(2*math.pi/elcMass)
  -- compute elctron temperature
  local negativeTemperature = runUpdater(temperatureElcCalc, tCurr, myDt, {numDensityElc,mom1dir3Elc,
    mom2dir3Elc,mom1dir4Elc,bField3d}, {temperatureElc})
...
function calcDiagnostics(tCurr, myDt)
  ...
  runUpdater(numDensityElcCalc, tCurr, myDt, {fElc, bField3d}, {numDensityElc})
  numDensityElc:scale(2*math.pi/elcMass)
