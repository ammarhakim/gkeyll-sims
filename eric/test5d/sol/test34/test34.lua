...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test32.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function rk3(tCurr, myDt)
  ...
  numDensityIon:scale(2*math.pi/ionMass)
  -- solve for potential
  local potentialStatus = computePotential(phiSLower, phiSUpper, numDensityIon, numDensityElc, phi3d)
