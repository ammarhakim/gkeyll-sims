...
-- 3-25-2016: load state of a test1.lua simulation and do some calculations
-- for debugging. no time stepping.
-- use to load a distribution function from another run and compute things
...
--fElc:sync()
-- apply boundary conditions to distribution functions
--bcStatus = applyBcToDistF(0.0, 0.0, fElc, fIon)
--if bcStatus == false then
--  Lucee.logInfo (string.format("-- Failed to apply boundary conditions"))
--end
-- apply zero inflow boundary conditions in z to ions
