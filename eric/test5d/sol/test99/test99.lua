...
tStart = 0.0
tEnd = 1e-9
dtSuggested = tEnd -- initial time-step to use (will be adjusted)
nFrames = 1
...
function rk1(tCurr, myDt)
  -- RK stage 1
  local myStatusElc = true
  local myDtSuggestedElc = 100
  local myStatusIon = true
  local myDtSuggestedIon = 100
  --local myStatusLBElcIon = true
  --local myDtSuggestedLBElcIon = 100
  --local myStatusLBElc = true
  --local myDtSuggestedLBElc = 100
...
function advanceFrame(tStart, tEnd, initDt)
  ...
  while tCurr<=tEnd do
    ...
    status, dtSuggested = rk1(tCurr, myDt)
