...
function applyIonPositivity(tCurr, myDt, distfIon)
  ...
  Lucee.logInfo(string.format("Ion perp energy corrected = %g %%", 100*perpCorrection  ))
  Lucee.logInfo(string.format("Ion afterCorrPerpEnergyVec = %.14g", afterCorrPerpEnergyVec:lastInsertedData()  ))
  Lucee.logInfo(string.format("Ion afterPosPerpEnergyVec = %.14g", afterPosPerpEnergyVec:lastInsertedData()  ))
  Lucee.logInfo(string.format("Ion beforePosPerpEnergyVec = %.14g", beforePosPerpEnergyVec:lastInsertedData()  ))
  ...
  Lucee.logInfo(string.format("Ion para energy corrected = %g %%", 100*paraCorrection  ))
  Lucee.logInfo(string.format("Ion afterCorrParaEnergyVec = %.14g", afterCorrParaEnergyVec:lastInsertedData()  ))
  Lucee.logInfo(string.format("Ion afterPosParaEnergyVec = %.14g", afterPosParaEnergyVec:lastInsertedData()  ))
  Lucee.logInfo(string.format("Ion beforePosParaEnergyVec = %.14g", beforePosParaEnergyVec:lastInsertedData()  ))
...
function calcLenardBernsteinElcIon(tCurr, myDt, fInitialElc, fInitialIon, fFinal)
  ...
  runUpdater(diffSlvrElcIon, tCurr, myDt, {fInitialElc, temperatureElc, --temperatureElc, temperatureElc,
    temperatureParaEqElc, temperaturePerpEqElc,
    bField3d, numDensityElc}, {fElcCollisions})
