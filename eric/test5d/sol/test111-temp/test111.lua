...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test111.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "test111"
...
function calcPotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 3.0e17--avgIonDensity:lastInsertedData()/totalVol--2.325e17
  -- solve for potential
