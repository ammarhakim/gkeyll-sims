...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test28.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
-- integrate sources and write out profiles
runUpdater(numDensityElcCalc, 0.0, 0.0, {elcSource, bField3d}, {numDensityElc})
numDensityElc:scale(2*math.pi/elcMass)
