...
function computePotential(phiSLower, phiSUpper, nIon, nElc, phiOut)
  ...
  phiSAverage:combine(0.5, phiSLowerSmoothed, 0.5, phiSUpperSmoothed)
  phiSAverage:sync()
  -- potential with an averaged potential on the upper-x boundary
  runUpdater(upperXPotentialBc, 0.0, 0.0, {phiSAverage}, {phiSLowerSmoothed, phiSUpperSmoothed, phiSAtEdge})
  phiSLowerSmoothed:sync()
  phiSUpperSmoothed:sync()
...
function writeFields(frameNum, tCurr)
  ...
  f1Elc:write( string.format("f1Elc_%d.h5", frameNum), tCurr)
  f1Ion:write( string.format("f1Ion_%d.h5", frameNum), tCurr)
end
