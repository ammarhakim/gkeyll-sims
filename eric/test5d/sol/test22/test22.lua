...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test22.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
-- 4-15-216: Added code to look at field in a cell
...
function applyBcToDistF(tCurr, myDt, fElc, fIon)
  ...
  -- calculate first vPar moment of the elc distribution function
