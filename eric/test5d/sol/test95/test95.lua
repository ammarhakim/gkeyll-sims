...
function elcTempProfile(x,y,z)
  return 5*initBackgroundProfile(x,y,z)
end
...
function applyElcPositivity(tCurr, myDt, distfElc)
  ...
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilParaElc, bField3d}, {kineticEnergyElc})
  kineticEnergyElc:scale(1/myDt)
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyElc}, {beforePosParaEnergyVec})
  ...
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilParaElc, bField3d}, {kineticEnergyElc})
  kineticEnergyElc:scale(1/myDt)
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyElc}, {afterPosParaEnergyVec})
  -- compute momentum after positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilDerivKeElc, bField3d}, {mom1dir3Elc})
  ...
  return true, afterPosEnergyVec:lastInsertedData() - beforePosEnergyVec:lastInsertedData(), afterPosParaEnergyVec:lastInsertedData() - beforePosParaEnergyVec:lastInsertedData()
end
...
function rk3(tCurr, myDt)
  ...
  local positivityElcStatus, stage1ElcEnergy, stage1ElcParaEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  ...
  positivityElcStatus, stage2ElcEnergy, stage2ElcParaEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  positivityIonStatus, stage2IonEnergy = applyIonPositivity(tCurr, myDt, f1Ion)
  ...
  positivityElcStatus, stage3ElcEnergy, stage3ElcParaEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  positivityIonStatus, stage3IonEnergy = applyIonPositivity(tCurr, myDt, f1Ion)
  ...
  if Lucee.getRank() == 0 then
    local totalEnergyAdded = stage3ElcEnergy + 2/3*stage2ElcEnergy + 1/6*stage1ElcEnergy
    local totalParaEnergyAdded = stage3ElcParaEnergy + 2/3*stage2ElcParaEnergy + 1/6*stage1ElcParaEnergy
    Lucee.logInfo(string.format("Total elc energy added from positivity = %g (%g %% in parallel)", totalEnergyAdded, 100*totalParaEnergyAdded/totalEnergyAdded))
...
if Lucee.IsRestarting then
  ...
  applyElcPositivity(0.0, 0.0, fElc)
