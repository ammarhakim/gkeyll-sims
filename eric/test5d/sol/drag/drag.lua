...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i diff.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function fIonProfile(x,y,z,v,mu)
  if math.abs(v) <= 2*vtIon and math.abs(mu) <= 4*ionMass*vtIon^2/(2*B0) then
    return 1
  else
    return 0
  end
...
generalIntegralIonCalc = Updater.SOLGeneralIntegralAtNodeCalc {
   onGrid = grid_ion_5d,
   basis5d = basis_ion_5d,
   basis3d = basis_3d,
   basis2d = basis_2d,
...
generalIntegralElcCalc = Updater.SOLGeneralIntegralAtNodeCalc {
   onGrid = grid_elc_5d,
   basis5d = basis_elc_5d,
   basis3d = basis_3d,
   basis2d = basis_2d,
...
function rk3(tCurr, myDt)
  local diffDtSuggestedIon
  local diffStatusIon
  local dragDtSuggestedIon
  local dragStatusIon

  -- calculate inputs for collision operator
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, oneFieldIon}, {numDensityIonNoWeight})
  --runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, hamilDerivKeIon}, {mom1dir3Ion})
  runUpdater(mom1VParaIonCalc, tCurr, myDt, {fIon, bField3d}, {mom1dir3Ion})
  mom1dir3Ion:scale(2*math.pi/ionMass)
  --mom1dir3Ion:clear(0.0)
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, hamilKeIon}, {kineticEnergyIon})
  -- calculate ion density and average ion density
  runUpdater(numDensityIonCalc, tCurr, myDt, {fIon, bField3d}, {numDensityIon})
  numDensityIon:scale(2*math.pi/ionMass)
  runUpdater(fieldInt3d, 0.0, 0.0, {numDensityIon}, {avgIonDensity})
  -- compute ion temperature
  runUpdater(temperatureIonCalc, tCurr, myDt, {numDensityIonNoWeight,kineticEnergyIon,mom1dir3Ion,bField3d},
    {temperatureIon})

  -- RK stage 1
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIon, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDrag, ionEnergyHistory})
  --Lucee.logInfo (string.format("Initial Energy = %g", ionEnergyHistory:lastInsertedData() ))
  f1Ion:copy(fIon)
  dragStatusIon, dragDtSuggestedIon = runUpdater(dragSlvrIon, tCurr, myDt, {fIon, mom1dir3Ion,
    numDensityIon, temperatureIon, numDensityIon}, {fIonCollisions})
  -- compute energy integrated in a cell from drag term
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDrag, ionEnergyHistory})
  --Lucee.logInfo (string.format("Drag Increment Energy = %g", ionEnergyHistory:lastInsertedData() ))
  -- accumulate drag term to update
  f1Ion:accumulate(myDt, fIonCollisions)
  -- compute diffusion term
  diffStatusIon, diffDtSuggestedIon = runUpdater(diffSlvrIon, tCurr, myDt, {fIon, temperatureIon, bField3d,
    numDensityIon}, {fIonCollisions, gVParIonCollisions, gMuIonCollisions})
  -- compute energy integrated in a cell from diffusion term
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDiff, ionEnergyHistory})
  --Lucee.logInfo (string.format("Diff Increment Energy = %g", ionEnergyHistory:lastInsertedData() ))

  --f1Ion:accumulate(myDt, fIonCollisions)
  ionEnergyAtCellDiff:scale(-1.0/myDt)
  ionEnergyAtCellAfterPositivity:clear(0.0)
  runUpdater(positivityScaleIonUpdater, tCurr, myDt, {fIonCollisions, ionEnergyAtCellDrag,
    ionEnergyAtCellAfterPositivity, ionEnergyAtCellDiff}, {f1Ion})

  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {f1Ion, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDrag, ionEnergyHistory})
  --Lucee.logInfo (string.format("End Energy = %g", ionEnergyHistory:lastInsertedData() ))

  if (diffStatusIon == false or dragStatusIon == false) then
    return false, math.min(dragDtSuggestedIon, diffDtSuggestedIon)
  end
  positivityStatus = applyPositivityAdvanced(tCurr, myDt, f1Elc, f1Ion)

  fIon:copy(f1Ion)
   -- calculate continuous time diagnostics and check to see if execution needs to end
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, hamilDerivKeExactIon}, {mom1dir3Ion})
...
function rk3oldold(tCurr, myDt)
  ...
  f1Ion:copy(fIon)
  dragStatusIon, dragDtSuggestedIon = runUpdater(dragSlvrIon, tCurr, myDt, {fIon, mom1dir3Ion,
    numDensityIonNoWeight, temperatureIon, numDensityIon}, {fIonCollisions})
  -- compute energy integrated in a cell
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDrag, ionEnergyHistory})
  ...
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDiff, ionEnergyHistory})
  ionEnergyAtCellDiff:scale(-myDt)
  ionEnergyAtCellAfterPositivity:clear(0.0)
  runUpdater(positivityScaleIonUpdater, tCurr, myDt, {fIonCollisions, ionEnergyAtCellDrag,
    ionEnergyAtCellAfterPositivity, ionEnergyAtCellDiff}, {f1Ion})
  ...
  positivityStatus = applyPositivity(tCurr, myDt, f1Elc, f1Ion)

  -- calculate inputs for collision operator
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {f1Ion, oneFieldIon}, {numDensityIonNoWeight})
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {f1Ion, hamilDerivKeExactIon}, {mom1dir3Ion})
  mom1dir3Ion:clear(0.0)
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {f1Ion, hamilKeIon}, {kineticEnergyIon})
  -- calculate ion density and average ion density
  ...
  -- RK stage 2
  fNewIon:copy(f1Ion)
  dragStatusIon, dragDtSuggestedIon = runUpdater(dragSlvrIon, tCurr, myDt, {f1Ion, mom1dir3Ion,
    numDensityIonNoWeight, temperatureIon, numDensityIon}, {fIonCollisions})
  -- compute energy integrated in a cell
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDrag, ionEnergyHistory})
  fNewIon:accumulate(myDt, fIonCollisions)

  diffStatusIon, diffDtSuggestedIon = runUpdater(diffSlvrIon, tCurr, myDt, {f1Ion, temperatureIon, bField3d,
    numDensityIon}, {fIonCollisions, gVParIonCollisions, gMuIonCollisions})
  -- compute energy integrated in a cell
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonCollisions, jacobianFieldIon, hamilKeIon},
    {ionEnergyAtCellDiff, ionEnergyHistory})
  ...
  ionEnergyAtCellAfterPositivity:clear(0.0)
  runUpdater(positivityScaleIonUpdater, tCurr, myDt, {fIonCollisions, ionEnergyAtCellDrag,
    ionEnergyAtCellAfterPositivity, ionEnergyAtCellDiff}, {fNewIon})
...
function calcDiagnostics(tCurr, myDt)
  ...
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fElc, oneFieldElc}, {numDensityElcNoWeight})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElc, hamilDerivKeElc}, {mom1dir3Elc})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElc, hamilKeElc}, {kineticEnergyElc})
  -- compute electron temperature
  runUpdater(temperatureElcCalc, tCurr, myDt, {numDensityElcNoWeight,kineticEnergyElc,mom1dir3Elc,bField3d},
    {temperatureElc})
  -- convert to ev
...
function calcSourceDiagnostics(tCurr, myDt, elcSource, ionSource)
  ...
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {elcSource, oneFieldElc}, {numDensityElcNoWeight})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {elcSource, hamilDerivKeElc}, {mom1dir3Elc})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {elcSource, hamilKeElc}, {kineticEnergyElc})
  -- compute electron temperature
  runUpdater(temperatureElcCalc, tCurr, myDt, {numDensityElcNoWeight,kineticEnergyElc,mom1dir3Elc,bField3d},
    {temperatureElc})
  -- convert to ev
  ...
  -- compute ion moments
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {ionSource, oneFieldIon}, {numDensityIonNoWeight})
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {ionSource, hamilDerivKeIon}, {mom1dir3Ion})
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {ionSource, hamilKeIon}, {kineticEnergyIon})
  -- compute ion temperature
  runUpdater(temperatureIonCalc, tCurr, myDt, {numDensityIonNoWeight,kineticEnergyIon,mom1dir3Ion,bField3d},
    {temperatureIon})
  -- convert to ev
