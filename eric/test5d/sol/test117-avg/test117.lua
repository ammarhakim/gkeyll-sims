...
-- start computing bg info at frame 1000
tCurr = tCurr + 1700*tFrame

for bgFrame = 1700, nFrames do
  numDensityElc:read("nElc_" .. bgFrame .. ".h5")
  bgDensityElc:accumulate(1/(nFrames-1700+1), numDensityElc)
end

for frame = 1700, nFrames do
