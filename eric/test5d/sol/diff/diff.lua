...
-- mpiexec -n 1 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i diff.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function rk3(tCurr, myDt)
  ...
  runUpdater(temperatureIonCalc, tCurr, myDt, {numDensityIon,kineticEnergyIon,mom1dir3Ion,bField3d},
    {temperatureIon})
  ...
  runUpdater(lenardBernsteinScaleIonUpdater, tCurr, myDt, {fIonCollisions, ionEnergyAtCellDrag,
...
function rk3oldold(tCurr, myDt)
  ...
  -- calculate inputs for collision operator
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, oneFieldIon}, {numDensityIon})
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIon, hamilDerivKeIon}, {mom1dir3Ion})
  ...
  -- calculate inputs for collision operator
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {f1Ion, oneFieldIon}, {numDensityIon})
