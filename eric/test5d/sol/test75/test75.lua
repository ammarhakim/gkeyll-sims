...
phaseDecomp = DecompRegionCalc5D.CartProd { cuts = {27, 27, 1, 1, 1} }
...
function calcPotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 2.51992e17 --avgIonDensity:lastInsertedData()/totalVol
  -- NOTE: Not the true ion density, but set this way for better comparison
  -- solve for potential
