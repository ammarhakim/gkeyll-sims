...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test57.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function calcCollisionsElc(tCurr, myDt, fInitial, fFinal)
  ...
  local negativeTemperature = runUpdater(temperatureElcCalc, 0.0, 0.0, {numDensityElc,kineticEnergyElc,mom1dir3Elc,bField3d},
    {temperatureElc})
  ...
  while convergenceStatus == false and iterCount < maxIter do
    ...
    runUpdater(maxwellianEval, 0.0, 0.0, {numDensityElc, mom1dir3ElcMaxwellianInput,
    ...
    runUpdater(generalIntegralElcCalc, 0.0, 0.0, {fElcMaxwellian, hamilDerivKeElc, bField3d}, {mom1dir3ElcMaxwellianNumerical})
    runUpdater(generalIntegralElcCalc, 0.0, 0.0, {fElcMaxwellian, hamilKeElc, bField3d}, {kineticEnergyElc})
    -- compute elc temperature
    runUpdater(temperatureElcCalc, 0.0, 0.0, {numDensityElc,kineticEnergyElc,mom1dir3ElcMaxwellianNumerical,bField3d},
      {temperatureElcMaxwellianNumerical})

    -- compute input parameters for next iteration
    convergenceStatus = runUpdater(maxwellianParameterFinder, 0.0, 0.0, {mom1dir3Elc, temperatureElc,
      mom1dir3ElcMaxwellianInput, temperatureElcMaxwellianInput,
      mom1dir3ElcMaxwellianNumerical, temperatureElcMaxwellianNumerical}, {mom1dir3ElcMaxwellianOutput,
      temperatureElcMaxwellianOutput})
