...
N_VPARA = 10
N_MU = N_VPARA/2
grid_alpha = (math.log(2) + 2*math.log(1/N_MU))/math.log(1/N_MU)
...
grid_elc_5d = Grid.NonUniformRectCart5D {
   ...
   mappings = {
     ...
     function(zeta)
       return zeta^grid_alpha*MU_UPPER_ELC
     end,
   },
   decomposition = phaseDecomp,
}
...
grid_ion_5d = Grid.NonUniformRectCart5D {
   ...
   mappings = {
     ...
     function(zeta)
       return zeta^grid_alpha*MU_UPPER_ION
     end,
   },
   decomposition = phaseDecomp,
}
...
-- Function that falls off from 1 to 1/4
...
function elcTempProfile(x,y,z)
  return 4*sourceTempProfile(x,y,z)
end
