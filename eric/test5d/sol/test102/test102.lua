...
function applyIonPositivity(tCurr, myDt, distfIon)
  ...
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilParaIon, bField3d}, {paraEnergyAtNodeBeforePositivity})
  -- compute perp energy before positivity
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilPerpIon, bField3d}, {perpEnergyAtNodeBeforePositivity})
  ...
  -- compute parallel energy after positivity
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilParaIon, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterPosParaEnergyVec})
  -- compute perp energy after positivity
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilPerpIon, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterPosPerpEnergyVec})

  -- need to sync ghost cells for drag update
  distfIon:sync()
  -- compute ion perp energy at nodes after positivity is applied
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilPerpIon, bField3d},
  ...
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIonPositivityDrag, hamilPerpIon, bField3d},
  ...
  runUpdater(positivityScaleIonUpdater, tCurr, myDt, {fIonPositivityDelta, perpEnergyAtNodeBeforePositivity,
  ...
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilParaIon, bField3d},
    {energyAtNodeAfterPositivity})
  ...
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {fIonPositivityDrag, hamilParaIon, bField3d},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  fIonPositivityDelta:combine(1.0, fIonPositivityDrag, -1.0, distfIon)
  -- add correct amount of fIonPositivityDelta to get correct energy at each node
  runUpdater(positivityScaleIonUpdater, tCurr, myDt, {fIonPositivityDelta, paraEnergyAtNodeBeforePositivity,
    energyAtNodeAfterPositivity, energyAtNodeAfterMaxDrag}, {distfIon})
  distfIon:sync()
  ...
  -- compute parallel energy after correction
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilParaIon, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterCorrParaEnergyVec})
  -- compute perp energy after correction
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilPerpIon, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterCorrPerpEnergyVec})

  local perpCorrection = (afterCorrPerpEnergyVec:lastInsertedData() - afterPosPerpEnergyVec:lastInsertedData())/
    (afterPosPerpEnergyVec:lastInsertedData() - beforePosPerpEnergyVec:lastInsertedData())
  Lucee.logInfo(string.format("Electron perp energy corrected = %g %%", 100*perpCorrection  ))

  local paraCorrection = (afterCorrParaEnergyVec:lastInsertedData() - afterPosParaEnergyVec:lastInsertedData())/
    (afterPosParaEnergyVec:lastInsertedData() - beforePosParaEnergyVec:lastInsertedData())
  Lucee.logInfo(string.format("Electron para energy corrected = %g %%", 100*paraCorrection  ))
  ...
  Lucee.logInfo(string.format("Ion Momentum change = %g %%",deltaU  ))
...
function applyElcPositivity(tCurr, myDt, distfElc)
  ...
  -- compute parallel energy before positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilParaElc, bField3d}, {paraEnergyAtNodeBeforePositivity})
  runUpdater(fieldInt3d, tCurr, myDt, {paraEnergyAtNodeBeforePositivity}, {beforePosParaEnergyVec})
  -- compute perp energy before positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilPerpElc, bField3d}, {perpEnergyAtNodeBeforePositivity})
  ...
  -- compute parallel energy after positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilParaElc, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterPosParaEnergyVec})
  -- compute perp energy after positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilPerpElc, bField3d}, {tempField3d})
  runUpdater(fieldInt3d, tCurr, myDt, {tempField3d}, {afterPosPerpEnergyVec})

  -- need to sync ghost cells for drag update
  distfElc:sync()
  -- compute elc perp energy at nodes after positivity is applied
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilPerpElc, bField3d},
    {energyAtNodeAfterPositivity})
  -- take a maximum drag step in mu direction
  ...
  -- compute energy in node after maximum drag step
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElcPositivityDrag, hamilPerpElc, bField3d},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  ...
  runUpdater(positivityScaleElcUpdater, tCurr, myDt, {fElcPositivityDelta, perpEnergyAtNodeBeforePositivity,
  ...
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilParaElc, bField3d},
    {energyAtNodeAfterPositivity})
  -- take a maximum drag step in v-parallel direction
  ...
  -- compute energy in node after maximum drag step
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElcPositivityDrag, hamilParaElc, bField3d},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  fElcPositivityDelta:combine(1.0, fElcPositivityDrag, -1.0, distfElc)
  -- add correct amount of fElcPositivityDelta to get correct energy at each node
  runUpdater(positivityScaleElcUpdater, tCurr, myDt, {fElcPositivityDelta, paraEnergyAtNodeBeforePositivity,
    energyAtNodeAfterPositivity, energyAtNodeAfterMaxDrag}, {distfElc})
  distfElc:sync()
  ...
  -- compute increment in momentum
  local deltaU = (afterPosMomentumVec:lastInsertedData() - beforePosMomentumVec:lastInsertedData())/beforePosMomentumVec:lastInsertedData()
  Lucee.logInfo(string.format("Electron Momentum change = %g %%",deltaU  ))
