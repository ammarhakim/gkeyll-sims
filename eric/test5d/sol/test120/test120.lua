...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test118.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "test120"
...
function sourceTempProfile(x,y,z)
  ...
  local a = deltaX/2
  local edgeVal = 1/4
  if r <= a and math.abs(z) < L_parallel/4 then
    return (1-edgeVal)*(1-r^2/a^2)^3 + edgeVal
  else
    return edgeVal
  end
...
-- write out some source field diagnostics
