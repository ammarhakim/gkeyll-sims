...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test68.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
tCurr = tCurr + 5100*tFrame

for frame = 5100, nFrames do
