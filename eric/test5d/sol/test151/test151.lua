...
function calcPotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 5.0e17--avgIonDensity:lastInsertedData()/totalVol--2.325e17
  -- solve for potential
...
function calcDiagnostics(tCurr, myDt)
  ...
  numDensityDelta:combine(-1.0, numDensityElc, 1.0, numDensityIon)
end
...
function writeFields(frameNum, tCurr)
  ...
  if Lucee.getRank() == 0 then
    os.execute("mv ".. filename .. "_" .. string.format("nDelta_%d.h5", frameNum) .. " density")
