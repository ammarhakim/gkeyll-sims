...
function calcDiagnostics(tCurr, myDt)
  ...
  runUpdater(heatFluxAtEdgeElcCalc, tCurr, myDt, {fElc,hamilDerivKeElc,hamilKeElc},
    {heatFluxLowerElc, heatFluxUpperElc})
  runUpdater(heatFluxAtEdgeIonCalc, tCurr, myDt, {fIon,hamilDerivKeIon,hamilKeIon},
