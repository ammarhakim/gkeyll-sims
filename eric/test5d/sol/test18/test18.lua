...
-- 4-11-16: like test 17 but with a uniform source everywhere
...
initSourceIon = Updater.EvalOnNodes5D {
   ...
   -- function to use for initialization
   evaluate = function (x,y,z,v,mu,t)
		 return sourceAmplitude*(2*math.pi*sourceTemp*eV/ionMass)^(-3/2)*
...
initSourceElc = Updater.EvalOnNodes5D {
   ...
   -- function to use for initialization
   evaluate = function (x,y,z,v,mu,t)
		 return sourceAmplitude*(2*math.pi*sourceTemp*eV/elcMass)^(-3/2)*
