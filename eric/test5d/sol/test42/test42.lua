...
-- mpiexec -n 1 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test36.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
...
function computePotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 1.8e16 --avgIonDensity:lastInsertedData()/totalVol
  -- solve for potential
