...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test100.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "test107"
...
-- to scale fEpsilonElc to have density "1" everywhere
...
-- to scale fEpsilonIon to have density "1" everywhere
...
-- stores average of ion/elc density
...
-- diagnostic to look at the values of a single cell in a 3d field vs. time
recordFieldInCell = Updater.RecordFieldInCell3D {
  onGrid = grid_3d,
  cellIndex = {18,18,5},
}
...
paraEnergyElcAtNodeBeforePositivity = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
perpEnergyElcAtNodeBeforePositivity = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
paraEnergyIonAtNodeBeforePositivity = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
perpEnergyIonAtNodeBeforePositivity = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
...
beforePosElcEnergyVec = DataStruct.DynVector { numComponents = 1, }
beforePosIonEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterPosIonEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterPosElcEnergyVec = DataStruct.DynVector { numComponents = 1, }
...
generalCellIntegralElcCalc = Updater.SOLEnergyAtCellCalc {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
  scaleFactor = 2*math.pi/elcMass^3
}
generalCellIntegralIonCalc = Updater.SOLEnergyAtCellCalc {
  onGrid = grid_ion_5d,
  basis5d = basis_ion_5d,
  basis3d = basis_3d,
  scaleFactor = 2*math.pi/ionMass^3
...
-- to get correct density in every cell
setCellAveragedDensityElc = Updater.SOLPositivityScaleCellUpdater {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
  positivityChecks = false,
}
setCellAveragedDensityIon = Updater.SOLPositivityScaleCellUpdater {
  onGrid = grid_ion_5d,
  basis5d = basis_ion_5d,
  basis3d = basis_3d,
  positivityChecks = false,
...
-- use to get a desired charge density
setChargeDensityElc = Updater.SOLDesiredChargeDensity5D {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
}
setChargeDensityIon = Updater.SOLDesiredChargeDensity5D {
  onGrid = grid_ion_5d,
  basis5d = basis_ion_5d,
  basis3d = basis_3d,
}
...
sigmaOld = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
sigmaNew = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
-- To store the cell-averaged density
elcDensityAtCellOld = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
ionDensityAtCellOld = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
elcDensityAtCellNew = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}
ionDensityAtCellNew = DataStruct.Field3D {
   onGrid = grid_3d,
   numComponents = basis_3d:numNodes(),
   ghost = {1, 1},
}

nElcOld = DataStruct.DynVector { numComponents = 1, }
nElcNew = DataStruct.DynVector { numComponents = 1, }
nIonOld = DataStruct.DynVector { numComponents = 1, }
nIonNew = DataStruct.DynVector { numComponents = 1, }

function applyPositivity(tCurr, myDt, distfIon, distfElc)
  -- compute energy before positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilKeIon}, {kineticEnergyIon})
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyIon}, {beforePosIonEnergyVec})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilKeElc}, {kineticEnergyElc})
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyElc}, {beforePosElcEnergyVec})
  
  -- compute parallel energy before positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilParaIon}, {paraEnergyIonAtNodeBeforePositivity})
  -- compute perp energy before positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilPerpIon}, {perpEnergyIonAtNodeBeforePositivity})
  -- compute parallel energy before positivity
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilParaElc}, {paraEnergyElcAtNodeBeforePositivity})
  -- compute perp energy before positivity
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilPerpElc}, {perpEnergyElcAtNodeBeforePositivity})
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityIon}, {nIonOld})
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityElc}, {nElcOld})
  -- compute old charge difference = n_i - n_e
  sigmaOld:combine(1.0, numDensityIon, -1.0, numDensityElc)
  -- compute cell-averaged density
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, oneFieldIon}, {ionDensityAtCellOld})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, oneFieldElc}, {elcDensityAtCellOld})
  -- zero out negative-valued nodes
  distfIon:clearNegative()
  distfElc:clearNegative()
  -- calculate new cell-averaged density
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, oneFieldIon}, {ionDensityAtCellNew})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, oneFieldElc}, {elcDensityAtCellNew})
  -- scale distribution functions to have old cell-averaged densities
  energyAtNodeAfterPositivity:clear(0.0)
  fIonPositivityDrag:clear(0.0)
  runUpdater(setCellAveragedDensityIon, tCurr, myDt, {distfIon, ionDensityAtCellOld, energyAtNodeAfterPositivity, ionDensityAtCellNew}, {fIonPositivityDrag})
  fElcPositivityDrag:clear(0.0)
  runUpdater(setCellAveragedDensityElc, tCurr, myDt, {distfElc, elcDensityAtCellOld, energyAtNodeAfterPositivity, elcDensityAtCellNew}, {fElcPositivityDrag})
  -- copy back to original distribution functions
  distfIon:copy(fIonPositivityDrag)
  distfElc:copy(fElcPositivityDrag)
  -- compute new density of each species
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, oneFieldIon, bField3d}, {numDensityIon})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, oneFieldElc, bField3d}, {numDensityElc})
  -- compute new charge difference = n_i - n_e
  sigmaNew:combine(1.0, numDensityIon, -1.0, numDensityElc)

  -- Add source particles until charge density is unchanged
  runUpdater(setChargeDensityIon, tCurr, myDt, {fEpsilonIon, sigmaNew, sigmaOld}, {distfIon})
  -- make sigma = n_e - n_i
  sigmaOld:scale(-1)
  sigmaNew:scale(-1)
  runUpdater(setChargeDensityElc, tCurr, myDt, {fEpsilonElc, sigmaNew, sigmaOld}, {distfElc})

  -- compute new density of each species
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, oneFieldIon, bField3d}, {numDensityIon})
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, oneFieldElc, bField3d}, {numDensityElc})
  -- TEMPORARY DIAGNOSTIC
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityIon}, {nIonNew})
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityElc}, {nElcNew})
  -- TEMPORARY DIAGNOSTIC
  Lucee.logInfo(string.format("Ion number change = %g %%",100*(nIonNew:lastInsertedData()-nIonOld:lastInsertedData())/nIonNew:lastInsertedData()  ))
  Lucee.logInfo(string.format("Elc number change = %g %%",100*(nElcNew:lastInsertedData()-nElcOld:lastInsertedData())/nElcNew:lastInsertedData()  ))

  -- ION POSITIVITY ENERGY STEP
  ...
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilPerpIon},
  ...
  runUpdater(positivityDragSliceMuIon, tCurr, myDt, {distfIon, energyAtNodeAfterPositivity,
    perpEnergyIonAtNodeBeforePositivity}, {fIonPositivityDrag})
  -- compute energy at cell after maximum drag step
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {fIonPositivityDrag, jacobianFieldIon, hamilPerpIon},
  ...
  runUpdater(positivityScaleCellIonUpdater, tCurr, myDt, {fIonPositivityDelta, perpEnergyIonAtNodeBeforePositivity,
  ...
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilParaIon},
    {energyAtNodeAfterPositivity})
  ...
  runUpdater(positivityDragSliceVParIon, tCurr, myDt, {distfIon, energyAtNodeAfterPositivity,
    paraEnergyIonAtNodeBeforePositivity, mom1dir3Ion, numDensityIon}, {fIonPositivityDrag})
  -- compute energy in node after maximum drag step
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {fIonPositivityDrag, jacobianFieldIon, hamilParaIon},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  fIonPositivityDelta:combine(1.0, fIonPositivityDrag, -1.0, distfIon)
  -- add correct amount of fIonPositivityDelta to get correct energy at each node
  runUpdater(positivityScaleCellIonUpdater, tCurr, myDt, {fIonPositivityDelta, paraEnergyIonAtNodeBeforePositivity,
    energyAtNodeAfterPositivity, energyAtNodeAfterMaxDrag}, {distfIon})
  distfIon:sync()
  ...
  -- ELECTRON POSITIVITY ENERGY STEP
  -- need to sync ghost cells for drag update
  distfElc:sync()
  -- compute momentum before positivity
  ...
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilPerpElc},
    {energyAtNodeAfterPositivity})
  -- take a maximum drag step in mu direction
  runUpdater(positivityDragSliceMuElc, tCurr, myDt, {distfElc, energyAtNodeAfterPositivity,
    perpEnergyElcAtNodeBeforePositivity}, {fElcPositivityDrag})
  -- compute energy at cell after maximum drag step
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {fElcPositivityDrag, jacobianFieldElc, hamilPerpElc},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  ...
  runUpdater(positivityScaleCellElcUpdater, tCurr, myDt, {fElcPositivityDelta, perpEnergyElcAtNodeBeforePositivity,
  ...
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilParaElc},
    {energyAtNodeAfterPositivity})
  -- take a maximum drag step in v-parallel direction
  runUpdater(positivityDragSliceVParElc, tCurr, myDt, {distfElc, energyAtNodeAfterPositivity,
    paraEnergyElcAtNodeBeforePositivity, mom1dir3Elc, numDensityElc}, {fElcPositivityDrag})
  -- compute energy in node after maximum drag step
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {fElcPositivityDrag, jacobianFieldElc, hamilParaElc},
    {energyAtNodeAfterMaxDrag})
  -- Compute the difference between distf post-positivity and distf post-drag
  fElcPositivityDelta:combine(1.0, fElcPositivityDrag, -1.0, distfElc)
  -- add correct amount of fElcPositivityDelta to get correct energy at each node
  runUpdater(positivityScaleCellElcUpdater, tCurr, myDt, {fElcPositivityDelta, paraEnergyElcAtNodeBeforePositivity,
    energyAtNodeAfterPositivity, energyAtNodeAfterMaxDrag}, {distfElc})
  distfElc:sync()
  ...
  -- compute energy after positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilKeIon}, {kineticEnergyIon})
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyIon}, {afterPosIonEnergyVec})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilKeElc}, {kineticEnergyElc})
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyElc}, {afterPosElcEnergyVec})

  -- returns power added to ions, power added to electrons
  local ionPositivityHeating = (afterPosIonEnergyVec:lastInsertedData()-beforePosIonEnergyVec:lastInsertedData())/myDt
  local elcPositivityHeating = (afterPosElcEnergyVec:lastInsertedData()-beforePosElcEnergyVec:lastInsertedData())/myDt
  return ionPositivityHeating, elcPositivityHeating
end
...
function applyIonPositivity(tCurr, myDt, distfIon)
  ...
  -- compute parallel energy before positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilParaIon}, {paraEnergyAtNodeBeforePositivity})
  -- compute perp energy before positivity
  runUpdater(generalCellIntegralIonCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilPerpIon}, {perpEnergyAtNodeBeforePositivity})
...
function applyElcPositivity(tCurr, myDt, distfElc)
  ...
  -- compute parallel energy before positivity
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilParaElc}, {paraEnergyAtNodeBeforePositivity})
  -- compute perp energy before positivity
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilPerpElc}, {perpEnergyAtNodeBeforePositivity})
  -- compute density before positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, oneFieldElc, bField3d}, {numDensityElc})
...
function calcLenardBernsteinElcElc(tCurr, myDt, fInitial, fFinal)
  ...
  --temperatureElc:clear(elcTemp*eV)
  ...
  --runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElcCollisions, hamilKeElc, bField3d}, {elcEnergyAtNodeDrag})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {fElcCollisions, jacobianFieldElc, hamilKeElc}, {elcEnergyAtNodeDrag})
  -- accumulate drag term times dt to distribution function
  fFinal:accumulate(myDt, fElcCollisions)
  
  runUpdater(diffSlvrElc, tCurr, myDt, {fInitial, temperatureElc, bField3d, numDensityElc}, {fElcCollisions})

  -- compute energy integrated in a cell for diffusion term only
  --runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElcCollisions, hamilKeElc, bField3d}, {elcEnergyAtNodeDiff})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {fElcCollisions, jacobianFieldElc, hamilKeElc}, {elcEnergyAtNodeDiff})
  
  --elcEnergyAtNodeDiff:scale(-1.0/myDt)
  ...
  --runUpdater(lenardBernsteinScaleElcUpdater, tCurr, myDt, {fElcCollisions, elcEnergyAtNodeDrag,
  --  energyAtNodeAfterPositivity, elcEnergyAtNodeDiff}, {fFinal})

  -- Final stage: Accumulate correction amount of diffusion to ensure no energy is added
  local diffStatus, diffDtSuggested = runUpdater(lenardBernsteinScaleElcUpdater, tCurr, myDt, {fElcCollisions, elcEnergyAtNodeDrag,
    elcEnergyAtNodeDiff, temperatureElc, bField3d, numDensityElc}, {fFinal})
...
function calcLenardBernsteinElcIon(tCurr, myDt, fInitialElc, fInitialIon, fFinal)
  ...
  --runUpdater(generalIntegralElcCalc, tCurr, myDt, {fElcCollisions, hamilKeElc, bField3d}, {elcEnergyAtNodeDiff})
  runUpdater(generalCellIntegralElcCalc, tCurr, myDt, {fElcCollisions, jacobianFieldElc, hamilKeElc},
    {elcEnergyAtNodeDiff})
  ...
  local diffStatus, diffDtSuggested = runUpdater(lenardBernsteinScaleElcIonUpdater,
    tCurr, myDt, {fElcCollisions, elcEnergyAtNodeDrag,
    elcEnergyAtNodeDiff, temperatureElc, bField3d, numDensityElc}, {fFinal})
...
function rk3(tCurr, myDt)
  ...
  local stage1IonEnergy, stage1ElcEnergy = applyPositivity(tCurr, myDt, f1Ion, f1Elc)
  ...
  local stage2IonEnergy, stage2ElcEnergy = applyPositivity(tCurr, myDt, f1Ion, f1Elc)
  ...
  local stage3IonEnergy, stage3ElcEnergy = applyPositivity(tCurr, myDt, f1Ion, f1Elc)
...
function calcContinuousDiagnostics(tCurr, myDt)
  -- store phi in a cell
  runUpdater(recordFieldInCell, tCurr, myDt, {phi3d}, {fieldInCellPhi})
  runUpdater(recordFieldInCell, tCurr, myDt, {numDensityElc}, {fieldInCellNumElc})
