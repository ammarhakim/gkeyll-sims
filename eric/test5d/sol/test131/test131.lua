...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test131.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "test131"
...
function initBackgroundProfile(x,y,z)
  return 1 - 0.25*(x-X_LOWER)/(X_UPPER-X_LOWER)
end
...
function sourceTempProfile(x,y,z)
  ...
  local lambdaSource = 0.02 --[m]
  local xSource = -0.06 + R0 + a0 --[m]
