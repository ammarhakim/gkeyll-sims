...
-- mpiexec -n 1 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i lbTestRecoveryAlt.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "lbTestRecoveryAlt"
...
initfElc = Updater.EvalOnNodes5D {
   ...
   evaluate = function (x,y,z,v,mu,t)
		 ...
		 local targetTemp = elcTemp/2*eV--elcTemp/2*eV
