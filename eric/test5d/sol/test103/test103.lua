...
beforeFloorEnergyVec = DataStruct.DynVector { numComponents = 1, }
...
function applyIonPositivity(tCurr, myDt, distfIon)
  -- compute energy before enforcing a density floor
  runUpdater(generalIntegralIonCalc, tCurr, myDt, {distfIon, hamilKeIon, bField3d}, {kineticEnergyIon})
  kineticEnergyIon:scale(1/myDt)
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyIon}, {beforeFloorEnergyVec})

  -- enforce a density floor in the domain
  runUpdater(enforceDensityFloorIon, tCurr, myDt, {fEpsilonIon, bField3d}, {distfIon})
  ...
  return afterPosEnergyVec:lastInsertedData() - beforePosEnergyVec:lastInsertedData(), beforePosEnergyVec:lastInsertedData() - beforeFloorEnergyVec:lastInsertedData()
end
...
function applyElcPositivity(tCurr, myDt, distfElc)
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {kineticEnergyElc}, {beforeFloorEnergyVec})

  -- enforce a density floor in the domain
  runUpdater(enforceDensityFloorElc, tCurr, myDt, {fEpsilonElc, bField3d}, {distfElc})
  -- recompute energy everywhere
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, hamilKeElc, bField3d}, {kineticEnergyElc})
  kineticEnergyElc:scale(1/myDt)
...
function rk3(tCurr, myDt)
  ...
  local stage1ElcEnergy, stage1ElcFloorEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  local stage1IonEnergy, stage1IonFloorEnergy = applyIonPositivity(tCurr, myDt, f1Ion)
  ...
  local stage2ElcEnergy, stage2ElcFloorEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  local stage2IonEnergy, stage2IonFloorEnergy = applyIonPositivity(tCurr, myDt, f1Ion)
  ...
  local stage3ElcEnergy, stage3ElcFloorEnergy = applyElcPositivity(tCurr, myDt, f1Elc)
  local stage3IonEnergy, stage3IonFloorEnergy = applyIonPositivity(tCurr, myDt, f1Ion)
