...
dragPerpSlvrElc = Updater.LenardBernsteinDragPerp3D2VUpdater {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
  basis2d = basis_2d,
...
dragParaSlvrElc = Updater.LenardBernsteinDragPara3D2VUpdater {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
  basis2d = basis_2d,
...
lenardBernsteinScaleElcUpdater = Updater.SOLPositivityScaleNodeUpdater {
  onGrid = grid_elc_5d,
  basis5d = basis_elc_5d,
  basis3d = basis_3d,
...
function applyIonPositivity(tCurr, myDt, distfIon)
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {paraEnergyAtNodeBeforePositivity}, {beforePosParaEnergyVec})
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {perpEnergyAtNodeBeforePositivity}, {beforePosPerpEnergyVec})
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {energyAtNodeAfterPositivity}, {afterPosPerpEnergyVec})
  ...
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilParaIon},
    {energyAtNodeAfterPositivity})
  -- TEMPORARY DIAGNOSTIC
  runUpdater(fieldInt3d, tCurr, myDt, {energyAtNodeAfterPositivity}, {afterPosParaEnergyVec})
  ...
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {fIonPositivityDrag, jacobianFieldIon, hamilParaIon},
    {energyAtNodeAfterMaxDrag})
  runUpdater(fieldInt3d, tCurr, myDt, {energyAtNodeAfterMaxDrag}, {afterDragParaEnergyVec})
  Lucee.logInfo(string.format("Ion Para Energy target = %g", beforePosParaEnergyVec:lastInsertedData() ))
  Lucee.logInfo(string.format("Ion Para Energy after pos = %g", afterPosParaEnergyVec:lastInsertedData() ))
  Lucee.logInfo(string.format("Ion Para Energy after drag = %g", afterDragParaEnergyVec:lastInsertedData() ))
  -- Compute the difference between distf post-positivity and distf post-drag
  fIonPositivityDelta:combine(1.0, fIonPositivityDrag, -1.0, distfIon)
  ...
  -- TEMPORARY DIAGNOSTIC
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilPerpIon}, {perpEnergyAtNodeBeforePositivity})
  runUpdater(fieldInt3d, tCurr, myDt, {perpEnergyAtNodeBeforePositivity}, {afterCorrPerpEnergyVec})
  local deltaEPerp = (afterCorrPerpEnergyVec:lastInsertedData() - beforePosPerpEnergyVec:lastInsertedData())/beforePosPerpEnergyVec:lastInsertedData()
  local perpCorrected = (afterCorrPerpEnergyVec:lastInsertedData()-afterPosPerpEnergyVec:lastInsertedData())/(afterPosPerpEnergyVec:lastInsertedData()-beforePosPerpEnergyVec:lastInsertedData())
  runUpdater(ionEnergyAtCellCalc, tCurr, myDt, {distfIon, jacobianFieldIon, hamilParaIon}, {paraEnergyAtNodeBeforePositivity})
  runUpdater(fieldInt3d, tCurr, myDt, {paraEnergyAtNodeBeforePositivity}, {afterCorrParaEnergyVec})
  local deltaEPara = (afterCorrParaEnergyVec:lastInsertedData() - beforePosParaEnergyVec:lastInsertedData())/beforePosParaEnergyVec:lastInsertedData()
  local paraCorrected = (afterCorrParaEnergyVec:lastInsertedData()-afterPosParaEnergyVec:lastInsertedData())/(afterPosParaEnergyVec:lastInsertedData()-beforePosParaEnergyVec:lastInsertedData())
  Lucee.logInfo(string.format("Ion Perp Energy change = %g %%",100*deltaEPerp  ))
  Lucee.logInfo(string.format("Ion Para Energy change = %g %%",100*deltaEPara  ))
  Lucee.logInfo(string.format("Ion Perp Energy corrected = %g %%",100*perpCorrected  ))
  Lucee.logInfo(string.format("Ion Para Energy corrected = %g %%",100*paraCorrected  ))
  ...
  return afterPosEnergyVec:lastInsertedData() - beforePosEnergyVec:lastInsertedData()
end

-- TEMPORARY DIAGNOSTIC STRUCTURES
beforePosPerpEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterPosPerpEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterCorrPerpEnergyVec = DataStruct.DynVector { numComponents = 1, }
beforePosParaEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterPosParaEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterDragParaEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterCorrParaEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterDragPerpEnergyVec = DataStruct.DynVector { numComponents = 1, }
afterCorrPerpEnergyVec = DataStruct.DynVector { numComponents = 1, }

afterPosTotalParticlesVec = DataStruct.DynVector { numComponents = 1, }
beforePosTotalParticlesVec = DataStruct.DynVector { numComponents = 1, }
...
function applyElcPositivity(tCurr, myDt, distfElc)
  ...
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityElc}, {beforePosTotalParticlesVec})
  ...
  runUpdater(elcEnergyAtCellCalc, tCurr, myDt, {fElcPositivityDrag, jacobianFieldElc, hamilPerpElc},
    {energyAtNodeAfterMaxDrag})
  runUpdater(fieldInt3d, tCurr, myDt, {energyAtNodeAfterMaxDrag}, {afterDragPerpEnergyVec})
  -- Compute the difference between distf post-positivity and distf post-drag
  ...
  runUpdater(elcEnergyAtCellCalc, tCurr, myDt, {distfElc, jacobianFieldElc, hamilPerpElc},
    {energyAtNodeAfterMaxDrag})
  runUpdater(fieldInt3d, tCurr, myDt, {energyAtNodeAfterMaxDrag}, {afterCorrPerpEnergyVec})
  
  Lucee.logInfo(string.format("Elc Perp Energy target = %.8g", beforePosPerpEnergyVec:lastInsertedData() ))
  Lucee.logInfo(string.format("Elc Perp Energy after pos = %.8g", afterPosPerpEnergyVec:lastInsertedData() ))
  Lucee.logInfo(string.format("Elc Perp Energy after drag = %.8g", afterDragPerpEnergyVec:lastInsertedData() ))
  Lucee.logInfo(string.format("Elc Perp Energy after correction = %.8g", afterCorrPerpEnergyVec:lastInsertedData() ))
  ...
  -- compute density after positivity
  runUpdater(generalIntegralElcCalc, tCurr, myDt, {distfElc, oneFieldElc, bField3d}, {numDensityElc})
  runUpdater(fieldInt3d, tCurr, myDt, {numDensityElc}, {afterPosTotalParticlesVec})
  local deltaN = (afterPosTotalParticlesVec:lastInsertedData() - beforePosTotalParticlesVec:lastInsertedData())/beforePosTotalParticlesVec:lastInsertedData()
  Lucee.logInfo(string.format("Electron number change = %g %%",100*deltaN ))
  ...
  local deltaEPara = (afterCorrParaEnergyVec:lastInsertedData() - beforePosParaEnergyVec:lastInsertedData())/beforePosParaEnergyVec:lastInsertedData()
  local paraCorrected = (afterCorrParaEnergyVec:lastInsertedData()-afterPosParaEnergyVec:lastInsertedData())/(afterPosParaEnergyVec:lastInsertedData()-beforePosParaEnergyVec:lastInsertedData())
  Lucee.logInfo(string.format("Electron Perp Energy change = %g %%",100*deltaEPerp  ))
  Lucee.logInfo(string.format("Electron Para Energy change = %g %%",100*deltaEPara  ))
  Lucee.logInfo(string.format("Electron Perp Energy corrected = %g %%",100*perpCorrected  ))
  Lucee.logInfo(string.format("Electron Perp Energy after parallel correction = %.8g",afterCorrPerpEnergyVec:lastInsertedData()  ))
  Lucee.logInfo(string.format("Electron Para Energy corrected = %g %%",100*paraCorrected  ))
  -- compute increment in momentum
  local deltaU = (afterPosMomentumVec:lastInsertedData() - beforePosMomentumVec:lastInsertedData())/beforePosMomentumVec:lastInsertedData()
...
function rk3(tCurr, myDt)
  ...
  local stage1ElcFloorEnergy, stage1IonFloorEnergy = applyDensityFloor(tCurr, myDt, f1Elc, f1Ion)
  ...
  local stage2ElcFloorEnergy, stage2IonFloorEnergy = applyDensityFloor(tCurr, myDt, f1Elc, f1Ion)
  ...
  local stage3ElcFloorEnergy, stage3IonFloorEnergy = applyDensityFloor(tCurr, myDt, f1Elc, f1Ion)
