...
V_bias = 20 -- [V]
-- derived parameters
vtElc   = math.sqrt(6*eV/elcMass) -- only used for grid
...
function calcPotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 2.325e17 --avgIonDensity:lastInsertedData()/totalVol--2.51992e17
  -- solve for potential
...
-- Read in or initialize distribution functions
