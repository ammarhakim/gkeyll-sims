...
phaseDecomp = DecompRegionCalc5D.CartProd { cuts = {14, 14, 2, 1, 1} }
...
fieldSolver = Updater.FemPoisson3D {
   ...
   bcLeft = { T ="D", V = 6.0},
   bcRight = { T ="D", V = 6.0}, -- dirichlet in x
   bcBottom = { T ="D", V = 6.0},
   bcTop = { T ="D", V = 6.0}, -- dirichlet in y
   bcBack = { T ="N", V = 0.0},
...
function calcPotential(nIon, nElc, phiOut)
  ...
  local n_i0 = 2.345e17--avgIonDensity:lastInsertedData()/totalVol--2.51992e17
  -- solve for potential
