...
elcMass   = ionMass/800--REDUCED ELECTRON MASS Lucee.ElectronMass
elcTemp   = 40 -- [eV]
ionTemp   = 40 -- [eV]
B_axis = 0.5  -- [T]
...
n0 = 7*10^18 -- [1/m^3]
V_bias = 0 -- [V]
P_SOL = 5.4e6/10 -- [W] divided by another factor of 2 for smaller box
...
function calcDiagnostics(tCurr, myDt)
  ...
  runUpdater(edgeMomentCalcElc, tCurr, myDt, {fElc, hamilParaElc}, {edgeKeElc})
  ...
  runUpdater(edgeMomentCalcIon, tCurr, myDt, {fIon, hamilParaIon}, {edgeKeIon})
