...
-- mpiexec -n 1 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i lbTestRecovery.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist
filename = "lbTestRecovery"
