...
-- mpiexec -n 4 /Users/eshi/Research/gkeyllall/par-opt/gkeyll/gkeyll -i test121.lua -pc_type lu -pc_factor_mat_solver_package superlu_dist -r 0
filename = "test122"
...
tStart = 0.0
tEnd = 30e-6
dtSuggested = 1e-6 -- initial time-step to use (will be adjusted)
nFrames = 30
...
function rk3(tCurr, myDt)
  ...
  myStatusLBElc = true
  myDtSuggestedLBElc = 1
  myStatusLBElcIon = true
  myDtSuggestedLBElcIon = 1
  myStatusIon, myDtSuggestedIon = runUpdater(pbSlvrIon, tCurr, myDt, {f1Ion, hamilIon}, {fNewIon})
  myStatusLBIon = true
  myDtSuggestedLBIon = 1
