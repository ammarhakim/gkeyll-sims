...
Lucee.logInfo(string.format("Total time in poisson solver = %g", poissonSlvr:totalAdvanceTime()) )
Lucee.logInfo(string.format("Total time in poisson bracket = %g", pbSlvr:totalAdvanceTime()) )
Lucee.logInfo(string.format("Total time in field energy diagnostic = %g", fieldEnergyCalc:totalAdvanceTime()) )
Lucee.logInfo(string.format("Total time in number density calc = %g", numDensityCalc:totalAdvanceTime()) )
