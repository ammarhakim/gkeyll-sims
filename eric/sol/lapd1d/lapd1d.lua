...
function rk3(tCurr, myDt)
  ...
  statusIon = pbStatusIon--(pbStatusIon and dragStatusIon) and diffStatusIon
  dtSuggestedElc = math.min(pbDtSuggestedElc, dragDtSuggestedElc, diffDtSuggestedElc)
  dtSuggestedIon = pbDtSuggestedIon--math.min(pbDtSuggestedIon, dragDtSuggestedIon, diffDtSuggestedIon)
