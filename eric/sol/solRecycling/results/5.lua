...
-- 7-6-2015: recycling coefficient = 0.5
...
function rk3(tCurr, myDt)
  ...
  -- compute outward ion flux
  runUpdater(momentsAtEdgesIonCalc, tCurr, myDt, {distfNewIon, hamilIonKeDg}, {momentsAtEdgesIonRK2})
  ...
  -- compute outward ion flux
  runUpdater(momentsAtEdgesIonCalc, tCurr, myDt, {distfNewIon, hamilIonKeDg}, {momentsAtEdgesIonRK3})
