...
runUpdater(mom0CalcElc, 0.0, 0.0, {particleSourceElc}, {particleSourceElcProfile})
particleSourceElcProfile:scale(2*math.pi*B0/elcMass)
particleSourceElcProfile:write( string.format("particleSourceElcProfile_%d.h5", 0), 0)
