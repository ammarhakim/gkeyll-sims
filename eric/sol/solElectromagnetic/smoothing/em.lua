...
-- updater to smooth phi
smoothPhi = Updater.SmoothQuadPhiToC1 {
   onGrid = grid_1d,
   basis = basis_1d,
   alpha = 1.0/3.0, -- control parameter. 1/3 leads to self-adjoint operator
}
...
function calcDiagnostics(curr, dt)
   calcDiscontinuousField(0.0, 0.0, phi1dC1, phi1dDg)
...
function rk3(tCurr, myDt)
   ...
   calcContinuous1dField(tCurr, myDt, phi1dDg, phi1dC0)
   -- Compute A-parallel
   runUpdater(electromagneticACalc, tCurr, myDt, {mom0Elc, mom0Ion, mom1Elc, mom1Ion}, {aParallel1dDg})
   calcContinuous1dField(tCurr, myDt, aParallel1dDg, aParallel1d)
   -- Copy continuous field back to discontinuous field
   ...
   -- Compute Hamiltonian
   calcHamiltonianElc(tCurr, myDt, phi1dC1, aParallel1d, aSquared1d, hamilKeElc, hamilElc)
   calcHamiltonianIon(tCurr, myDt, phi1dC1, aParallel1d, aSquared1d, hamilKeIon, hamilIon)
   ...
   calcContinuous1dField(tCurr, myDt, phi1dDg, phi1dC0)
   runUpdater(smoothPhi, tCurr, myDt, {phi1dC0}, {phi1dC1})
   -- Compute A-parallel
   runUpdater(electromagneticACalc, tCurr, myDt, {mom0Elc, mom0Ion, mom1Elc, mom1Ion}, {aParallel1dDg})
   calcContinuous1dField(tCurr, myDt, aParallel1dDg, aParallel1d)
   -- Copy continuous field back to discontinuous field
...
calcContinuous1dField(0.0, 0.0, phi1dDg, phi1dC0)
runUpdater(smoothPhi, 0.0, 0.0, {phi1dC0}, {phi1dC1})
-- calculate initial Hamiltonian
calcHamiltonianElc(0.0, 0.0, phi1dC1, aParallel1d, aSquared1d, hamilKeElc, hamilElc)
calcHamiltonianIon(0.0, 0.0, phi1dC1, aParallel1d, aSquared1d, hamilKeIon, hamilIon)
