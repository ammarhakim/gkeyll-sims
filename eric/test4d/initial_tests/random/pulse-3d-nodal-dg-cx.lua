...
basis = NodalFiniteElement3D.CompletePolynomialElement {
...
function pulse(x,y,z)
   local xc, yc, zc = 0.5, 0.5, 0.5
   local r2 = (x-xc)^2 --+ (y-yc)^2 + (z-zc)^2
...
advectionEqn = HyperEquation.AdvectionTemplated3D {
   -- advection velocity
   speeds = {1.0, 0, 0}
}
