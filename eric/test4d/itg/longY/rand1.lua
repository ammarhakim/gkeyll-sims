...
-- 10-29-15: wrong potential calculation
...
function perturbDensityProfile(x,y)
  ...
  return 1e-3*(vtKinetic/omega_s)/L_T*math.random(-1,1)
end
...
-- initialize density potential on continuous grid
-- does not contain f_0, instead this will be multiplied with f_0
initDensityPerturb = Updater.EvalOnNodes2D {
   onGrid = grid_2d,
   basis = basis_2d,
...
-- create updater to copy a continuous 2D field to a 2D discontinuous field
