...
ionMass = 2.014*Lucee.ProtonMass -- (deuterium ions)
kineticMass   = Lucee.ElectronMass
adiabaticMass = ionMass
electronTemp = 2072 -- [eV]
ionTemp = 2072 -- [ev]
kineticTemp   = electronTemp
adiabaticTemp = ionTemp
B0 = 1.91   -- [T]
R0 = 1.313  -- [m]
a  = 0.4701 -- [m]
...
c_s       = math.sqrt(electronTemp*eV/ionMass)
omega_i   = math.abs(kineticCharge*B0/ionMass)
rho_s     = c_s/omega_i
deltaR    = 32*rho_s
L_T       = R/4
